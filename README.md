...
**TKTK: Describe suspendedfutures.org here.**
...
```
cd suspendedfutures.org
mkvirtualenv suspendedfutures.org
...
```
* * * * * ubuntu bash /home/ubuntu/apps/suspendedfutures.org/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|suspendedfutures.org|tweet|`location`||
|suspendedfutures.org|facebook|`location`||
|suspendedfutures.org|email|`location`||
|suspendedfutures.org|new-comment||
|suspendedfutures.org|open-share-discuss||
|suspendedfutures.org|close-share-discuss||
|suspendedfutures.org|summary-copied||
|suspendedfutures.org|featured-tweet-action|`action`|
|suspendedfutures.org|featured-facebook-action|`action`|
